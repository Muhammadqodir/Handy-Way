...
public class CategorysGirdAdapter  extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.get().load("https://handyway.uz/API/category_preview_master/get_preview.php?category_id="+item.getId()+"&?="+System.currentTimeMillis()).error(R.drawable.ic_icons8_error_1).into(((ImageView) root.findViewById(R.id.ivPreview)));
        return root;
    }
}